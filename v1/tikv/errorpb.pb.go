...
const file_v1_tikv_errorpb_proto_rawDesc = "" +
	...
	"\x13undetermined_result\x18\x16 \x01(\v2\x18.tikv.UndeterminedResultR\x12undeterminedResultR\vstale_epochB)Z'github.com/vdaas/vald-client-go/v1/tikvb\x06proto3"
