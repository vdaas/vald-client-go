...
replace (
	cloud.google.com/go => cloud.google.com/go v0.104.1-0.20221003221141-373d2fc3d3f6
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.42.1-0.20221003221141-373d2fc3d3f6
