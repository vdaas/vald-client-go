...
replace (
	cloud.google.com/go => cloud.google.com/go v0.123.1-0.20260115052307-18dec3a31f1d
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.72.1-0.20260115052307-18dec3a31f1d
