...
replace (
	cloud.google.com/go => cloud.google.com/go v0.115.2-0.20240912230037-b45d2ee9488b
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.62.1-0.20240912230037-b45d2ee9488b
