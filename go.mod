...
replace (
	cloud.google.com/go => cloud.google.com/go v0.110.3-0.20230614202212-4eb8a58b1ca8
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.51.3-0.20230614202212-4eb8a58b1ca8
