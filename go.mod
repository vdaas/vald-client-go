...
replace (
	cloud.google.com/go => cloud.google.com/go v0.123.1-0.20251017065103-c9569ccde064
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.71.1-0.20251017065103-c9569ccde064
