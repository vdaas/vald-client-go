...
replace (
	cloud.google.com/go => cloud.google.com/go v0.123.1-0.20251205092000-6c6945bd93a4
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.72.1-0.20251205092000-6c6945bd93a4
