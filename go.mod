...
replace (
	cloud.google.com/go => cloud.google.com/go v0.115.1-0.20240801193819-443e0ee35d1d
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.62.1-0.20240801193819-443e0ee35d1d
