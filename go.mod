...
replace (
	cloud.google.com/go => cloud.google.com/go v0.115.2-0.20240924000358-3380aa4af560
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.63.1-0.20240924000358-3380aa4af560
