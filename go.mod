...
replace (
	cloud.google.com/go => cloud.google.com/go v0.120.1-0.20250403191734-14e8e132d9d5
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.67.1-0.20250403191734-14e8e132d9d5
