...
replace (
	cloud.google.com/go => cloud.google.com/go v0.115.2-0.20241004050401-e7c85acc80a8
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.63.2-0.20241004050401-e7c85acc80a8
