...
replace (
	cloud.google.com/go => cloud.google.com/go v0.121.2-0.20250520075209-e7f03a7fcec7
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.68.1-0.20250520075209-e7f03a7fcec7
