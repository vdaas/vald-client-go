...
replace (
	cloud.google.com/go => cloud.google.com/go v0.115.2-0.20241008224549-de566700a2bc
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.63.2-0.20241008224549-de566700a2bc
