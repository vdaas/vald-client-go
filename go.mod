...
replace (
	cloud.google.com/go => cloud.google.com/go v0.120.2-0.20250416213900-74559fc6a1e9
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.67.1-0.20250416213900-74559fc6a1e9
