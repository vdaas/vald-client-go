...
replace (
	cloud.google.com/go => cloud.google.com/go v0.115.1-0.20240619125020-d8bd2c1ffc4f
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.61.1-0.20240619125020-d8bd2c1ffc4f
