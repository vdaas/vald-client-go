...
replace (
	cloud.google.com/go => cloud.google.com/go v0.121.3-0.20250610161940-5259a3db180b
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.69.1-0.20250610161940-5259a3db180b
