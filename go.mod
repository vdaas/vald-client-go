...
replace (
	cloud.google.com/go => cloud.google.com/go v0.110.1-0.20230310153551-88d3eda7124f
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.48.1-0.20230310153551-88d3eda7124f
