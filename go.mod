...
replace (
	cloud.google.com/go => cloud.google.com/go v0.116.1-0.20241114041457-42507887523f
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.64.1-0.20241114041457-42507887523f
