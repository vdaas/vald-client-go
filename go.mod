...
replace (
	cloud.google.com/go => cloud.google.com/go v0.116.1-0.20241025204824-e5bec20f4af8
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.63.2-0.20241025204824-e5bec20f4af8
