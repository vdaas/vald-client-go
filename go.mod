...
replace (
	cloud.google.com/go => cloud.google.com/go v0.121.4-0.20250702053318-2205d27d8fff
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.69.1-0.20250702053318-2205d27d8fff
