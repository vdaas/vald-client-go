...
replace (
	...
	golang.org/x/net => golang.org/x/net v0.0.0-20220524220425-1d687d428aca
	...
	google.golang.org/genproto => google.golang.org/genproto v0.0.0-20220524164028-0aa58a9287dd
