...
replace (
	cloud.google.com/go => cloud.google.com/go v0.116.1-0.20241104222623-5ff0fdca069c
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.64.1-0.20241105052133-3ae0d4597945
