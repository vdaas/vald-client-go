...
replace (
	cloud.google.com/go => cloud.google.com/go v0.121.5-0.20250803070430-f59fcfffdfcd
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.69.1-0.20250803070430-f59fcfffdfcd
