...
replace (
	cloud.google.com/go => cloud.google.com/go v0.123.1-0.20251020064633-3d8d0a9ced2b
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.71.1-0.20251020064633-3d8d0a9ced2b
