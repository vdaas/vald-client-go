...
replace (
	cloud.google.com/go => cloud.google.com/go v0.122.1-0.20250908204327-d9b6d46de703
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.70.1-0.20250908204327-d9b6d46de703
