...
replace (
	cloud.google.com/go => cloud.google.com/go v0.113.1-0.20240518050252-adf91f9fd37f
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.61.1-0.20240518050252-adf91f9fd37f
