...
replace (
	cloud.google.com/go => cloud.google.com/go v0.115.2-0.20241001195025-f98396e074df
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.63.1-0.20241001195025-f98396e074df
