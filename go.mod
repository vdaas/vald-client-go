...
replace (
	cloud.google.com/go => cloud.google.com/go v0.121.3-0.20250528225214-0036073affee
	cloud.google.com/go/bigquery => cloud.google.com/go/bigquery v1.69.1-0.20250528225214-0036073affee
